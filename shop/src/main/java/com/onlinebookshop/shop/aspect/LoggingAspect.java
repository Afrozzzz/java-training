...
public class LoggingAspect {
    ...
    public Object aroundServiceMethods(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Object result = joinPoint.proceed();
        long endTime = System.currentTimeMillis();
        System.out.println("------Logging: Method execution time " + joinPoint.getSignature().getName() + " executed in: "
    ...
    public void afterThrowingServiceMethods(Exception exception) {
        System.out.println("----Logging from aspect: Method threw exception " + exception + " -------");
    }
}
